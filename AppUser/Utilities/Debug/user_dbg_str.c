...
/**
  * @brief 把字符串转为数字 支持16进制转换,但是16进制字母必须是大写的,且格式为以0X开头的.支持负数
  * @param *str:数字字符串指针 *res:转换完的结果存放地址.
  * @retval 0，成功转换完成.其他,错误代码 1,数据格式错误.2,16进制位数为0.3,起始格式错误.4,十进制位数为0.
  */
...
/**
  * @brief 得到指令名
  * @param *str:源字符串 *cmdname:指令名 *nlen:指令名长度 maxlen:最大长度(做限制,指令不可能太长的)	
  * @retval 0,成功;其他,失败
  */
...
/**
  * @brief 从str中得到函数名
  * @param *str:源字符串指针 *fname:获取到的函数名字指针 *pnum:函数的参数个数 *rval:是否需要显示返回值(0,不需要;1,需要)
  * @retval 0,成功;其他,错误代码.
  */
...
/**
  ...
  * @param *str:源字符串指针 *fparm:参数字符串指针 *ptype:参数类型 0，数字;1，字符串;0XFF，参数错误
  * @retval 0,已经无参数了;其他,下一个参数的偏移量.
  */
...
/**
  * @brief 从str中得到函数参数
  * @param str:源字符串; parn:参数的多少.0表示无参数 void类型
  * @retval 0,成功;其他,错误代码.
  */
