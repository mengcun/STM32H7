/**
  ******************************************************************************
  * @file    STM32H7_CoreBoard/AppUser/Utilities/ULibs/User_Lib.c
  * @author  CME
 ...
 ===============================================================================
  [..]
	The User_Lib canbe used as follows:
	(#)...
		(++)...
				(+++)...
  @endverbatim
...
/** @addtogroup STM32H743II_CoreBoard
  * @{
  */
/** @defgroup User_Lib User_Lib
  * @brief 提供一些常用的sting、mem操作函数以及Modbus CRC16函数
  * @{
  */
/* Exported const ------------------------------------------------------------------------------*/
/** @defgroup User_Lib_Exported_const User Lib Exported const
  * @{
  */
/**
  * @brief CRC 高位字节值表
...
/**
  ...
  * @param _pStr :待转换的ASCII码串. 可以以逗号，#或0结束。
  * @retval			  
  */
...
/**
  ...
  * @param _pBuf : 参与校验的数据
  *		   _usLen : 数据长度
  * @retval	16位整数值。 对于Modbus ，此结果高字节先传送，低字节后传送。
  *
