/**
  ******************************************************************************
  * @file    STM32H7_CoreBoard/Template_C_H/Template.c
...
/** @defgroup Template_Private_Functions_Prototypes Template Private Functions Prototypes
  * @{
  */
//CODING HERE
/** @}
*/		
/*----------------------------Template Private Functions Prototypes--------------------------------*/ 
